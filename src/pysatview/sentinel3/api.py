...
sentinel_path = Path(__file__).parent.parent.parent / "get_data" / "saternal3"
...
class Sentinel3API(BaseSatelliteAPI):
    ...
    def __init__(self):
        ...
        base_dir = Path(__file__).parent.parent.parent / "get_data" / "saternal3" / "data" / "eumetview_sentinel3"
